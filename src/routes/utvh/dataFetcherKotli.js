...
export async function fetchDataKotels() {
  try {
    const responseKotel1 = await axios.get('http://169.254.6.19:3002/api/kotel1-data');
    const responseKotel2 = await axios.get('http://169.254.6.19:3002/api/kotel2-data');
    const responseKotel3 = await axios.get('http://169.254.6.19:3002/api/kotel3-data');
