...
export const generateTemperatureChartVR1 = async () => {
  return generateChart(
    ...
    [
      ...
      'Температура в топке печь ВР1', 'Температура на входе печи дожига печь ВР1', 'Температура на выходе печи дожига печь ВР1',
      'Температура камеры выгрузки печь ВР1', 'Температура дымовых газов котла печь ВР1', 'Температура газов до скруббера печь ВР1',
      'Температура газов после скруббера печь ВР1', 'Температура воды в ванне скруббер печь ВР1'
    ],
    [
      'Температура 1-СК', 'Температура 2-СК', 'Температура 3-СК',
      'Температура в топке', 'Температура на входе печи дожига', 'Температура на выходе печи дожига',
      'Температура камеры выгрузки', 'Температура дымовых газов котла', 'Температура газов до скруббера',
      'Температура газов после скруббера', 'Температура воды в ванне скруббер'
    ],
    'Температура',
...
export const generateTemperatureChartVR2 = async () => {
  return generateChart(
    ...
    [
      ...
      'Температура в топке печь ВР2', 'Температура вверху камеры загрузки печь ВР2', 'Температура внизу камеры загрузки печь ВР2',
      'Температура на входе печи дожига печь ВР2', 'Температура на выходе печи дожига печь ВР2', 'Температура камеры выгрузки печь ВР2',
      'Температура дымовых газов котла печь ВР2', 'Температура газов до скруббера печь ВР2',
      'Температура газов после скруббера печь ВР2', 'Температура воды в ванне скруббер печь ВР2',
      'Температура гранул после холод-ка печь ВР2'
    ],
    [
      'Температура 1-СК', 'Температура 2-СК', 'Температура 3-СК',
      'Температура в топке', 'Температура вверху камеры загрузки', 'Температура внизу камеры загрузки',
      'Температура на входе печи дожига', 'Температура на выходе печи дожига', 'Температура камеры выгрузки',
      'Температура дымовых газов котла', 'Температура газов до скруббера',
      'Температура газов после скруббера', 'Температура воды в ванне скруббер',
...
export const generatePressureChartVR1 = async () => {
  return generateChart(
    ...
    [
      ...
      'Разрежение в пространстве котла утилизатора печь ВР1', 'Разрежение низ загрузочной камеры печь ВР1'
    ],
    [
      'Давление пара в барабане котла', 'Разрежение в топке',
      'Разрежение в пространстве котла утилизатора', 'Разрежение низ загрузочной камеры'
    ],
    'Давление/Разрежение',
...
export const generatePressureChartVR2 = async () => {
  return generateChart(
    ...
    [
      ...
      'Разрежение в пространстве котла утилизатора печь ВР2', 'Разрежение низ загрузочной камеры печь ВР2'
    ],
    [
      'Давление пара в барабане котла', 'Разрежение в топке',
      'Разрежение в пространстве котла утилизатора', 'Разрежение низ загрузочной камеры'
